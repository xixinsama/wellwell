...
const ROOM_RUNTIME_SCRIPT: Script = preload("res://addons/platformer_kit/world/runtime/room_runtime.gd")
const WORLD_DATA_SCRIPT: Script = preload("res://addons/platformer_kit/world/data/world_data.gd")
const ROOM_TRANSITION: Script = preload("res://addons/platformer_kit/world/transition/room_transition.gd")
const SAVE_SNAPSHOT_SCRIPT: Script = preload("res://addons/platformer_kit/save/save_snapshot.gd")
...
func bind_save_manager(save_manager: Node) -> void:
	bind_persistence_source(save_manager)
...
func persist_loaded_entity_states() -> void:
	for room_runtime: Node in _loaded_rooms.values():
		if room_runtime != null and room_runtime.has_method("persist_entity_states"):
			room_runtime.call("persist_entity_states")
...
func _get_save_manager() -> Object:
	if is_instance_valid(_persistence_source):
