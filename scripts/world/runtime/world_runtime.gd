...
const ROOM_RUNTIME_SCRIPT: Script = preload("res://scripts/world/runtime/room_runtime.gd")
const WORLD_DATA_SCRIPT: Script = preload("res://scripts/world/data/world_data.gd")
const ROOM_TRANSITION: Script = preload("res://scripts/world/runtime/room_transition.gd")
