...
const IMPORTER_PATH := "res://addons/world_editor/authoring/world/world_room_importer.gd"
const WORLD_SERVICE := preload("res://addons/world_editor/authoring/world/world_resource_service.gd")
